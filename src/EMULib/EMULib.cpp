...
#if defined(WINDOWS) || defined(UNIX) || defined(MAEMO) || defined(__PLAYBOOK__)
...
#if defined(UNIX) || defined(MAEMO) || defined(__PLAYBOOK__)
...
#if defined(UNIX) || defined(MAEMO) || defined(NXC2600) || defined(STMP3700)
